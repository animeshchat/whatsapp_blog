...
!! insert_group_list("movies",[], "Bollywood Movies Whatsapp Groups","button",[25,75], "bollywood") 
...
!! insert_group_list("",["a","bollywood","news"],"Bollywood News Whatsapp Group","button",[0,25], "entertainment") 
